...
#define voltagePin  0  // The external voltage with a potential divider (470k // 47k) ADC 0
#define vanePin     1   // The wind vane with a 10k pull DOWN ADC 1
...
//      // *********** EXTERNAL VOLTAGE ***************************************
//      // From Vcc-470k--47k-GND potential divider
...
// CHANGED for ADC - 12 bits? OR read with 10 bit resolution?
...
void convertWindDirection(int reading)
{
  ...
  {
    windDirectionArray[8]++;    // This if for No Connection!
  }
