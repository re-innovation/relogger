...
// #define cardDetect 9  // The SD card detect is on pin 6  - NOT AVAILABLE NOW!!
...
#define battVoltagePin A0   // The battery voltage with a potential divider (470k//100k)
...
const char headers[] PROGMEM = "Ref, Date, Time, Wind1, AC/Wind2, Direction, Batt V, Ext V, Current";  // Headers for the top of the file
...
//      cardDetectFlag=digitalRead(cardDetect); 
...
//        Serial.flush();
//      }
//      if(cardDetectFlag==LOW&&cardDetectOld==HIGH&&calibrateFlag==HIGH)
//      {
...
//        createfilename();
//      }
//      cardDetectOld = cardDetectFlag;  // Store the old value of the card detect          
...
//      
  ...
  //    
      ...
      dataString += comma;
      dataString += ExternalVoltStr;  // External Voltage reading
      dataString += comma;
